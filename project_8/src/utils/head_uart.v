...
`define OFF_UART_DATA       'h4
`define OFF_UART_IER        'h5
`define OFF_UART_IIR        'h6
//`define OFF_UART_LCR        'h7
`define OFF_UART_LSR        'h8
`define OFF_UART_DIVR       'h9
`define OFF_UART_DIVT       'h10
